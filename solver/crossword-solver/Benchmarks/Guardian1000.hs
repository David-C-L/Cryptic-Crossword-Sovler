...
guardian 
  = [((21701,"Crispa"),("A figure gone berserk in indignation",7),"DUDGEON"),
     ...
     ((21746,"Shed"),("Beats American children's game in \"Three Sisters\"",10),"FUSTIGATES"),
     ((21746,"Shed"),("Classical mantrap that's never been touched",6),"VIRGIN"),
     ...
     ((21746,"Shed"),("Middle bit of Yorkshire-man's fish tail?",8),"ENDOCARP"),
     ...
     ((21746,"Shed"),("Bird's better suited to Cartesian co-ordinates",7),"APTERYX"),
     ...
     ((21746,"Shed"),("Best thing to do to the Titanic when there's an orchestra playing",7),"ABANDON"),
